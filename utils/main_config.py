...
ISP_DEFAULT = {
    'default': {
        ...
        'sensitivity_rules': {
            'LOW/NON_SENSITIVE': {
                'description': (
                    'Data that can be shared publicly or within coordination structures without risk of harm'
                    'to individuals or operations.'
                ),
            ...
            'HIGH_SENSITIVE': {
                'description': (
                    'Data that could cause significant harm to individuals or agencies if disclosed. '
                    'Requires prior approval and strong protection mechanisms.'
                ),
                'data and information type': [
