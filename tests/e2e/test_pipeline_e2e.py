...
def mock_isp_rules():
    ...
    return {
        'default': {
            'sensitivity_rules': {
                'SEVERE_SENSITIVE': {
                    'data and information type': ['Personal data of beneficiaries']
                },
                'HIGH_SENSITIVE': {
                    'data and information type': ['Survey data at household level']
                },
                'MODERATE_SENSITIVE': {
                    'data and information type': ['Aggregated data']
                },
                'NON_SENSITIVE': {
                    'data and information type': ['Public statistics']
                }
            }
        }
    }
