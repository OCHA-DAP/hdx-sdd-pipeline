...
class TestPipelineFactory:
    ...
    def test_create_pii_llm(self, mock_openai, factory):
        ...
        mock_openai.assert_called_once_with(
            ...
            endpoint=factory.config.OPENAI_ENDPOINT,
            api_key=factory.config.OPENAI_API_KEY,
        )
    ...
    def test_create_pipeline_with_different_models(
        ...
        mock_config.PII_REFLECT_MODEL = 'deepseek-v4'
        ...
        # Verify provider was instantiated correctly 4 times
        assert mock_openai.call_count == 4

        # Verify correct arguments were passed
        mock_openai.assert_any_call(
            model_name='gpt-4.1',
            endpoint=mock_config.OPENAI_ENDPOINT,
