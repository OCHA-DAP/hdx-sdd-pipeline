...
class TestAzureOpenAIProvider:
    ...
    def test_generate_success(self, provider, mock_client):
        ...
        # Call generate
        result, comp_tokens, prompt_tokens = provider.generate(prompt='Test prompt', max_tokens=100)
    ...
    def test_generate_json_success(self, provider, mock_client):
        ...
        result, comp_tokens, prompt_tokens = provider.generate_json(prompt='Generate JSON', max_tokens=200)
    ...
    def test_generate_json_nested_structure(self, provider, mock_client):
        ...
        assert result == {'outer': {'inner': {'value': 123}}, 'array': [1, 2, 3]}
